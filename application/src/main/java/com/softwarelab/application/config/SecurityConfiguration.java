...
import com.softwarelab.application.config.jwt.JwtAuthenticationProvider;
import com.softwarelab.application.config.jwt.JwtTokenAuthenticationProcessingFilter;
import com.softwarelab.application.config.jwt.SkipPathRequestMatcher;
import com.softwarelab.application.config.jwt.extractor.TokenExtractor;
import com.softwarelab.application.config.rest.RestAuthenticationProvider;
import com.softwarelab.application.config.rest.RestLoginProcessingFilter;
import com.softwarelab.application.handler.ErrorResponseHandler;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected static final String[] NON_TOKEN_BASED_AUTH_ENTRY_POINTS = new String[]{"/api/files/**","/app/**","/index.html", "/static/**", "/api/noauth/**", "/webjars/**", "/api/whiteLabel/**"};
