...
import com.softwarelab.application.websocket.WebSocketClient;
...
@Slf4j
public abstract class AbstractWebBaseTest {
    ...
    public SysUser getTestUser() {
        ...
        sysUser.setId(TEST_USER_ID.toString());
    ...
    public App getDemoApp() {
        ...
        app.setAdditionalInfo("{\"imageName\":\"" + AbstractWebBaseTest.DEMO_APP_IMAGE + "\",\"ports\":[{\"port\":8080,\"type\":\"http\",\"entrance\":true}]}");
        return app;
    }
    ...
    public App getHelloWorldApp() {
        ...
        app.setStatus(DbConst.STATUS_NORMAL);
        app.setLogo(getImageBytes());
        app.setAdditionalInfo("{\"imageName\":\"" + AbstractWebBaseTest.HELLO_WORLD_APP_NAME + "\"}");
        return app;
    }
